...
ARG BASE_IMAGE="ghcr.io/damienoleary/nginx-proxy-connect-stable-alpine:armv6-latest"
# Could be "-debug"
ARG BASE_IMAGE_SUFFIX=""
FROM ${BASE_IMAGE}${BASE_IMAGE_SUFFIX}

# Link image to original repository on GitHub
LABEL org.opencontainers.image.source=https://github.com/damienoleary/docker-registry-proxy
